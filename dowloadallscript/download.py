...
class DownloadPdfs:
    ...
    def __init__(self) -> None:
        ...
        self.fileCount = 1                  # Note : File No of Excel File eg: if filename is              --                                  "finalExcel18.xlsx" write 18 as fileno is 18

        self.starting = 337               # Note : starting number from where we want to start downloading

        self.downloadPath = r"D:\Abhay\bihar vidhan mandal scraping jyot\download"    # Note: download Path

        self.excel_file = fr'finalExcel\finalExcel{self.fileCount}.xlsx'             # Path to your Excel file
    ...
    def download(self) -> None:
        ...
        # Iterate over rows
        for index in range(self.starting,len(df["PageLinks"])):
